...
var KTAppInbox = (function () {
  ...
  var _initEditor = function (form, editor) {
    ...
    if (toolbar) {
      KTUtil.addClass(
        toolbar,
        "px-5 border-top-0 border-left-0 border-right-0"
      );
    }
  ...
  return {
    ...
    initList: function () {
      ...
      KTUtil.on(
        _listEl,
        '[data-inbox="message"] [data-inbox="actions"] .checkbox input',
        "click",
        function () {
    ...
    initView: function () {
      ...
      KTUtil.on(_viewEl, '[data-inbox="message"]', "click", function (e) {
        ...
        if (
          e.target === toolbarEl ||
          (toolbarEl && toolbarEl.contains(e.target) === true)
        ) {
          return false;
        }
