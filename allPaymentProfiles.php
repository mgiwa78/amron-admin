    ...
    <div class="subheader py-2 py-lg-6  subheader-solid " id="kt_subheader">
        <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center">
                ...
                $allPaymentProfileIds = FetchPaymentProfileIDs();
                ?>
                <!--end::Dropdown-->
            </div>
            <!--end::Toolbar-->
            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    ...
                    <div class="card-toolbar">
                        ...
                        <!--begin::Button-->
                        <a href="?action=createPaymentsProfile" class="btn btn-primary font-weight-bolder">
                    ...
                    <table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable">
                        <thead>
                            <tr>
                                ...
                                <th title="Field #0">Profile Name</th>
                                <th title="Field #2">Amount Due</th>
                                <th title="Field #3">Amount Paid</th>
                                <th title="Field #4">Description</th>
                                <th title="Field #7">Type</th>
                        ...
                        <tbody>
                            ...
                            <?php
                            foreach ($allPaymentProfileIds as $key => $ProfileIds) {
                                # code...
                                $PaymentProfileData = FetchPaymentProfileByID($ProfileIds[0]);
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="pr-0 text-right">
                                        <a href="?action=paymentProfileData" class="btn btn-icon btn-light btn-hover-primary btn-sm">
