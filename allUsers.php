            ...
            <div class="card card-custom gutter-b">
                ...
                <div class="card-header border-0 py-5">
                    <h3 class="card-title align-items-start flex-column">
                        ...
                        <span class="text-muted mt-3 font-weight-bold font-size-sm">Total 3 users</span>
                    </h3>
                                    ...
                                    <tr>
                                        <td class="pl-0 py-8">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <span class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Mr Muhammad Mukhtar</span>
                                                    <span class="text-muted font-weight-bold d-block">Manager</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="pl-0 py-0">
                                            <div class="d-flex align-items-center">
                                                <div class="symbol symbol-50 symbol-light mr-4">
                                                    <span class="symbol-label">
                                                        <img src="assets/media/svg/avatars/038-boy-16.svg" class="h-75 align-self-end" alt="">
                                                    </span>
                                                </div>
                                                <div>
                                                    <span class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Engineer Muhideen</span>
                                                    <span class="text-muted font-weight-bold d-block">Chief of Operations</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="pl-0 py-8">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <span class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Archtect Lukman Wayde</span>
                                                    <span class="text-muted font-weight-bold d-block">Lead Architect</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
