            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">
                            Sent Mails Table
                            <span class="d-block text-muted pt-2 font-size-sm">Mails Info</span>
                        </h3>
                    </div>
                    <div class="card-toolbar">
                        ...
                        <!--begin::Button-->
                        <a href="?action=sendMail" class="btn btn-primary font-weight-bolder">
                ...
                <div class="card-body">
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-9 col-xl-8">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4 my-2 my-md-0">
                                        <div class="d-flex align-items-center">
                                            <label class="mr-3 mb-0 d-none d-md-block">Mail Type:</label>
                                    ...
                                    <div class="col-md-4 my-2 my-md-0">
                                        <div class="d-flex align-items-center">
                                            <label class="mr-3 mb-0 d-none d-md-block">Sent:</label>
                    ...
                    <table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable">
                        <thead>
                            <tr>
                                <th title="Field #1">Mail ID</th>

                                <th title="Field #4">Sent To</th>
                                <th title="Field #5">Email</th>
                                <th title="Field #6">Date Sent</th>
                                <th title="Field #7">Gate Way</th>
